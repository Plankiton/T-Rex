...
-----------------
    ...
    example:
        echo "joao, maria, laura, marteus" | getter 'laura' -b ','
...
---------------
    ...
    example:
        echo "joao, .maria, .laura, marteus" | getter '^\.' -b ',' -s ', '

-t| --template / pattern
-------------------------
    the template is to change the output, in pattern you will write a regex and this regex will be used on "-t"
...
def main():
    ...
    args.add_argument( '-b', '--break-char',
            help = "break char in the text input",
            type = str,
            dest = 'break_char'
            )
